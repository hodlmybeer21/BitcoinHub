          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto py-4">
              ...
              <div className="px-4 mb-6">
                ...
                {navLinks.map((link) => {
                  const linkClass = `${isActiveLink(link.href) ? 'bg-primary/10 text-primary' : 'text-muted-foreground hover:bg-muted/50'} flex items-center px-3 py-2.5 rounded-lg text-sm font-medium cursor-pointer`;
                  // /games/* are externalized static HTML files (vercel.json passthrough).
                  // Use plain <a> for full navigation — wouter's <Link> would pushState to a
                  // non-SPA route and hit the catch-all <Route component={NotFound} />.
                  return link.href.startsWith('/games/') ? (
